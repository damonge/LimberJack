...
\begin{align}
  ...
  &\Delta_\ell^{IA}(k)=-\sqrt{\frac{(\ell+2)!}{(\ell-2)!}}
                       \int dz\,p_z(z)\,b_{\rm IA}(z)\,T_\delta(k,z)\,\frac{j_\ell(k\chi(z))}{(k\chi(z))^2},  \\
...
\longrightarrow0\\
 ...
 &\tilde{\Delta}_\ell^{IA}(k)=p_z(\chi_\ell)\,b_I(\chi_\ell)\,D(\chi_\ell)\,H(\chi_\ell)\frac{\sqrt{(\ell+2)(\ell+1)\ell(\ell-1)}}{(\ell+1/2)^2}\\
